      ...
      <div className="justify-center flex-1 max-w-6xl px-4 py-4 mx-auto lg:py-8 md:px-6">
        <div className="overflow-x-auto bg-white rounded shadow">
          <div className="flex items-center justify-between border-b border-gray-300 px-6 py-4 pb-4">
            ...
            <Link href={"/admin/contact/edit"} className="primary-btn">
              Edit Contact
            </Link>
          </div>
          <div className="relative z-10 overflow-hidden bg-white">
            <div className="-mx-4 flex flex-wrap lg:justify-between p-6 lg:p-12">
                  ...
                  <div className="mb-8 flex w-full max-w-[370px]">
                    ...
                    <div className="w-full">
                      ...
                      {webData?.contact?.whatsapp?.map((mobile, index) => (
                        <a href={`https://wa.me/${mobile}`} key={index} target="_blank">
                          <p className="text-base">+91 {mobile}</p>
                        </a>
                      ))}
                    </div>
